...
const phases = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { title: "Deploy to Railway", status: "done", sortOrder: 1 },
...
export async function POST() {
  ...
  // Allow seeding if no secret is set (first-time setup)
  // In production, set SEED_SECRET env var to protect this endpoint
